...
public class AllSeliniumAssign{    
@Test()   public void facebook()
{
	...
	driver.findElement(By.xpath("//div/input[@name='reg_email__']")).sendKeys("admin546@gmail.com");
...
@Test()   public void excelsheet() throws IOException 
{
	String filePath="C:\\Users\\ei13109\\eclipse-workspace";
...
@Test()   public void firefox()  
	{                  
	System.setProperty("webdriver.gecko.driver", "C:\\Prajwal\\geckodriver.exe");
	WebDriver driver = new FirefoxDriver();
	driver.get("https://www.facebook.com");   
	}
@Test()  public void tabledetails() 
	{
	String str;
	System.setProperty("webdriver.chrome.driver", "C:\\Prajwal\\chromedriver.exe");
	WebDriver driver = new ChromeDriver();
...
@Test()   public void hrmleave()
{
	...
	driver.findElement(By.xpath("//div/div[2]/div/div/input")).sendKeys("2022-10-24");
	driver.findElement(By.xpath("//button[@type='submit']")).click();
	}
